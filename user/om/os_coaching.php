...
$results = $db->query("SELECT * FROM coaching_information WHERE dir_name = 'jay.talosig'");
			...
			<table id="" class="display" cellspacing="0" width="100%">
				...
				<tbody>
					...
					while($row = $results->fetch_assoc()){
						...
						echo "<td><a class='change_status' href='view_os.php?id=".$row['reference_no']."'>View</a></td>";
						echo "<td><a class='change_status' href='edit.php?id=".$row['reference_no']."'>Edit</a></td>";
						echo "<td><a class='change_status' href='delete.php?id=".$row['reference_no']."'>Delete</a></td>";
						echo "</tr>";
					}
					?>
