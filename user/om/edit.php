            ...
            <div id="sigwrapper">
                 ...
                 <div id="agentsigparent">
                    ...
                    <div id="agentsigchild2"><br /><br /><br />
                      ...
                      <span id="empposition">Supervisor's Signature</span>
                    </div>                    
                 </div>
                 ...
                 <div id="omsigparent">
                    <div id="omsigchild1">
                      <?php
                        if($dir_signature && $dir_signature == 'Ok'){
                    ...
                    <div id="omsigchild2"><br /><br /><br />
                      ...
                      <span id="empposition">Director's Signature</span>
                    </div>                    
                 </div>
