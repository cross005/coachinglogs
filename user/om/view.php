...
if($id != $session_id){
  header("location:../../include/not_found_om.php");
}
...
<head>
    ...
    function hidValue(){
      ...
      var hid_os_confirmation = document.getElementById("hid_os_confirmation").value;
      if(hidden == "Ok"){
        document.getElementById("button").style.visibility = "hidden";
      }

      //Disable button if OS confirmation is not 'Ok'
      if(hid_os_confirmation != "Ok"){
...
<div id="spacing"></div>
    ...
    <div id="main">
      <div id="wrapper1">
        ...
        <input type = "hidden" name = "hid_val" id = "hid_val" value = "<?php echo $om_confirmation; ?>" />
        <input type = "hidden" id = "hid_os_confirmation" value = "<?php echo $os_confirmation; ?>" />     
            <div id="body3">
              <span class="smart">
          ...
          <div id="sigwrapper">
                 ...
                 <div id="omsigparent">
                    ...
                    <div id="omsigchild2"><br /><br /><br />
                      ...
                      <span id="empposition">Operations Manager's Signature</span><br />
...
$results = $db->query("SELECT * FROM users WHERE username = '$os_name'");
while ($row = $results->fetch_assoc()) {
  $os_signature = $row['signature'];
}

$results = $db->query("SELECT supervisor_name FROM users WHERE username = '$agent_username'");
while ($row = $results->fetch_assoc()) {
