    ...
    <div id="main">
      <div id="wrapper1">
        ...
        <input type = "hidden" name = "hid_val" id = "hid_val" value = "<?php echo $agent_confirmation; ?>" /> 
            <div id="body3">
              <span class="smart">
                Supervisor's Name: <?php echo $agent_fullname; ?> 
            ...
            <div class = "content"><span class = "smart">3. Agent's Commitment:</span>
              ...
              <textarea name="agents_commitment" id="agents_commitment" required placeholder="Required field. Enter your commitment here..."><?php if(isset($_POST['hid_text'])){echo $_POST['hid_text'];}?><?php echo $agent_commitment;?></textarea>
            </div>
          ...
          <div id="sigwrapper">
                 ...
                 <div id="agentsigparent">
                    ...
                    <div id="agentsigchild2"><br /><br /><br />
                      ...
                      <span id="empposition">Supervisor's Signature</span><br/>
                 ...
                 <div id="omsigparent">
                    ...
                    <div id="omsigchild2"><br /><br /><br />
                      ...
                      <span id="empposition">Director's Signature</span><br />
                    </div>                    
                 </div>
                 ...
                 <div id="ossigparent">
                    ...
                    <div id="ossigchild2"><br /><br /><br />
                      ...
                      <span id="empposition">Operation Managers's Signature</span>
                    </div> 
                 </div>
