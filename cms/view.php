...
if($id != $session_id){
  header("location:../include/not_found_os.php");
}
...
while ($row = $results->fetch_assoc()) {
  $os_users_fullname = $row['user_fullname'];

}

$results = $db->query("SELECT * FROM users WHERE username = '$db_om_name'");
while ($row = $results->fetch_assoc()) {
  $om_user_fullname = $row['user_fullname'];
...
<div id="spacing"></div>
    ...
    <div id="main">
      <div id="wrapper1">
        ...
        <form action="testpdf.php" method="post" name="form" enctype="multipart/form-data">
            ...
            <div id="sigwrapper">
                 ...
                 <div id="omsigparent">
                    ...
                    <div id="omsigchild2"><br /><br /><br />
                      ...
                      <span id="empname"><?php echo $om_user_fullname; ?></span><br />
                 ...
                 <div id="ossigparent">
                    ...
                    <div id="ossigchild2"><br /><br /><br />
                      <span id="empname"><?php echo $os_users_fullname; ?></span><br />
                      <span id="empposition">Operations Supervisor's Signature</span><br />
                      <input id="button" type="button" value="Accept">
                      <input type="hidden" name="temp_ref_no" value = "<?php echo $id; ?>"/>
                      <input type="hidden" id = "om_hid_confirmation" name="om_hid_confirmation" value = "<?php echo $om_confirmation; ?>"/>
                      <input type="submit" id="pdf" name="pdf" value="Print as PDF"/>
                    </div> 
                 </div>
...
if(isset($_POST['submit'])){
  ...
  if($password == $os_password){
    ...
    $results = $db->query("UPDATE coaching_information SET os_date_confirmation = '$Today',
                                                           os_confirmation = 'Ok', 
                                                           om_signature = '$om_signature1'  
